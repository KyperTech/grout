...
var Project = function (_ApiAction) {
	...
	function Project(owner, name) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Project).call(this, 'projects/' + name, { owner: owner, name: name }));
  ...
  */
   ...
   */
		value: function File(fileData) {
			...
			return new _File3.default(this, fileData);
		}
   ...
   */
		value: function Account(username) {
			...
			return new _ApiAction3.default('accounts/' + username, this);
		}
   ...
   */
		...
		get: function get() {
			...
			return new _ApiAction3.default('accounts', this);
		}
	}, {
		key: 'Groups',
		get: function get() {
			...
			return new _ApiAction3.default('groups', this);
		}
	}]);
