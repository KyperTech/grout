  ...
  */
   ...
   */
		value: function Account(username) {
			var action = new _ApiAction2.default('accounts/' + username, this);
			logger.debug({
   ...
   */
		value: function Group(groupName) {
			var action = new _Group3.default(groupName, this);
			logger.debug({
   ...
   */
		value: function Template(templateName) {
			var action = new _ApiAction2.default('templates/' + templateName, this);
			logger.debug({
		...
		key: 'Projects',
		get: function get() {
			var action = new _ApiAction2.default('projects', this);
			logger.debug({
		...
		key: 'Accounts',
		get: function get() {
			var action = new _ApiAction2.default('accounts', this);
			logger.debug({
		...
		key: 'Groups',
		get: function get() {
			var action = new _ApiAction2.default('groups', this);
			logger.debug({
		...
		key: 'Templates',
		get: function get() {
			var action = new _ApiAction2.default('templates', this);
			logger.debug({
