...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('lodash'), require('aws-sdk'), require('firebase'), require('jwt-decode'), require('superagent')) : typeof define === 'function' && define.amd ? define(['lodash', 'aws-sdk', 'firebase', 'jwt-decode', 'superagent'], factory) : global.Grout = factory(global._, global.AWS, global.Firebase, global.jwtDecode, global.superagent);
})(this, function (_, AWS, Firebase, jwtDecode, superagent) {
	'use strict';
   ...
   */
    ...
    */
	...
	matter = new Matter(config.appName, config.matterOptions);
  ...
  */
   ...
   */
	...
	var Grout = (function (_Matter) {
		...
		function Grout(options) {
			_classCallCheck(this, Grout);

			//Call matter with tessellate
			_get(Object.getPrototypeOf(Grout.prototype), 'constructor', this).call(this, config.appName, { localServer: true });
			// matter(this);
		}
